...
watch(open, value => { if (value) { loadRecent().finally(loadHandoff); handoffTimer = window.setInterval(loadHandoff, 15000) } else { window.clearInterval(handoffTimer) } })
