<template>
  <section class="page orders-page">
    ...
    <div v-for="order in orders" :key="order.orderNo" class="card order-card">
      ...
      <div v-if="order.orderStatus === 0 || order.orderStatus === 2" class="order-actions">
