<template>
  <section class="page order-detail-page">
    ...
    <template v-else-if="order">
      ...
      <div class="order-actions"><van-button v-if="order.orderStatus === 0" plain type="danger" @click="cancel">取消订单</van-button><van-button v-if="order.orderStatus === 2" type="primary" @click="confirm">确认收货</van-button></div>
    </template>
